            ...
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    ...
                    <p className="mt-2 text-sm text-gray-700">
                        Lista de todos os contatos e leads das marcas (Bliss, MyFormula, etc).
                    </p>
                </div>
                                ...
                                {people.map((person) => (
                                    <tr key={person.email}>
                                        ...
                                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                            <a href="#" className="text-indigo-600 hover:text-indigo-900">Edit<span className="sr-only">, {person.name}</span></a>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
