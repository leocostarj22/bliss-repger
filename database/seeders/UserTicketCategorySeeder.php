...
class UserTicketCategorySeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $this->command->info("Criando categorias para tickets de usuários em {$companies->count()} empresas:");
        ...
        $totalCategories = $companies->count() * count($userCategories);
        $this->command->info("✅ Categorias para tickets de usuários criadas com sucesso!");
